...
function whichCountry(){
  ...
  if(optionArr[5]=="1" && optionArr[6]=="2" && optionArr[7]=="2" && optionArr[8]=="2"){
    ...
    // var setTitle = "멕시코<br>(Mexico, FEFARMEX)"
    $("#result_country1").html("멕시코");
    $("#result_country2").html("(Mexico, FEFARMEX)");
    // var setText02 = "<li>도시: Chetumal, Puebla</li><li>실습 기관: 지역약국, 병원약국, 대학교 연구 실험실</li><li>숙박: 무료 (Chetumal 방문하는 학생에게 300 USD 지원)</li><li>실습 외 문화행사: National Symposium of TOFARMEX (4월, 11월 무료)</li><br>1) Puebla : Huejotzingo, Cholula, Tlaxcala, Orizaba, and Pachuca 등 주말 근교 여행<br>2) Chetumal : Cancun, Merida, Bacalar, Kohunlich, Campeche city 등 주말 근교 여행";
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>도시: Chetumal, Puebla</li><li>실습 기관: 지역약국, 병원약국, 대학교 연구 실험실</li><li>숙박: 무료 (Chetumal 방문하는 학생에게 300 USD 지원)</li><li>실습 외 문화행사: National Symposium of TOFARMEX (4월, 11월 무료)</li><br>1) Puebla : Huejotzingo, Cholula, Tlaxcala, Orizaba, and Pachuca 등 주말 근교 여행<br>2) Chetumal : Cancun, Merida, Bacalar, Kohunlich, Campeche city 등 주말 근교 여행");
  }
    ...
    $("#result_country1").html("크로아티아");
    $("#result_country2").html("(Croatia, CPSA)");
    ...
    // var setText02 = "<li>도시: 자그레브(Zagreb), 스플릿 (Split)</li><li>언어: 영어</li><li>파견 기간: 2주 ~ 3주 (Summer / Winter)</li><li>실습 기관: 지역 약국, 대학교 연구 실험실</li><li>숙박: 기숙사 (무료)</li><li>실습 외 문화 행사: Festival을 포함한 다양한 Social Event</li>";
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>도시: 자그레브(Zagreb), 스플릿 (Split)</li><li>언어: 영어</li><li>파견 기간: 2주 ~ 3주 (Summer / Winter)</li><li>실습 기관: 지역 약국, 대학교 연구 실험실</li><li>숙박: 기숙사 (무료)</li><li>실습 외 문화 행사: Festival을 포함한 다양한 Social Event</li>");
  }
    ...
    $("#result_country1").html("이집트");
    $("#result_country2").html("(Egypt, EPSF)");
    ...
    // var setText02 = "<li>도시: 자그레브(Zagreb), 스플릿 (Split)</li><li>파견 기간: 2주 ~ 3주 (Summer / Winter)</li><li>언어: 영어</li><li>실습 기관: 지역 약국, 대학교 연구 실험실</li><li>숙박: 기숙사 (무료)</li><li>실습 외 문화 행사: Festival을 포함한 다양한 Social Event</li>";
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>도시: 자그레브(Zagreb), 스플릿 (Split)</li><li>파견 기간: 2주 ~ 3주 (Summer / Winter)</li><li>언어: 영어</li><li>실습 기관: 지역 약국, 대학교 연구 실험실</li><li>숙박: 기숙사 (무료)</li><li>실습 외 문화 행사: Festival을 포함한 다양한 Social Event</li>");
  }
    ...
    $("#result_country1").html("인도");
    $("#result_country2").html("(India, MAPS)");
    ...
    // var setText02 = "<li>실습 기관: 병원 약국, 지역 약국</li><li>파견 기간: 6월, 7월, 12월, 1월 (3-8 주)</li><li>언어: 영어</li><li>숙박: 대학교 기숙사, 게스트하우스(약$15/night)</li><li>실습 외 문화행사: 학습, 문화, 스포츠 등 MAPS 교환학생관리국에서 기획한 다양한 행사</li>";
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>실습 기관: 병원 약국, 지역 약국</li><li>파견 기간: 6월, 7월, 12월, 1월 (3-8 주)</li><li>언어: 영어</li><li>숙박: 대학교 기숙사, 게스트하우스(약$15/night)</li><li>실습 외 문화행사: 학습, 문화, 스포츠 등 MAPS 교환학생관리국에서 기획한 다양한 행사</li>");
  }
  else if(optionArr[5]=="2" && optionArr[6]=="2" && optionArr[7]=="2"){
    index = 4;
    $(".result_country_img").attr("src", "static/public/img/country/대만1.jpg");
    // $("#result_country").text("대만 (Taiwan, PSA-Taiwan)");
    $("#result_country1").html("대만");
    $("#result_country2").html("(Taiwan, PSA-Taiwan)");
    ...
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>실습 기관: 병원 약국, 대학교 실험 연구실, 지역 약국</li><li>기간: 3~6주(보통 4주)</li><li>언어: 영어</li><li>숙박: 기숙사</li><li>실습 외 문화 행사: 평일에는 대만 문화를 경험할 수 있는 여러 가지 활동이, 주말에는 대만 PSA-Taiwan 학생들과의 근교 여행이 준비되어있습니다.</li>");
  }
    ...
    // $("#result_country").text("일본 (Japan, APS-Japan)");
    $("#result_country1").html("일본");
    $("#result_country2").html("(Taiwan, PSA-Taiwan)");
    ...
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>실습 기관: 병원, 지역 약국, 연구기관, 제약산업기관으로의 견학</li><li>기간: 2월, 8월(2주)</li><li>언어: 영어</li><li>숙박: 게스트 하우스 (3500JPY/night)</li><li>실습 외 문화 행사: APS-JAPAN 교환학생관리국 부원들과 함께 지역 축제 방문, 다양한 Social night 프로그램</li>");
  }
    ...
    $("#result_country1").html("영국");
    $("#result_country2").html("(UK, BPSA)");
    ...
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>실습 기관: 지역약국, 대학교 연구 실험실, 병원 약국</li><li>파견 기간: 2~4주, 6~9월 중 가능</li><li>언어: 영어</li><li>지역: 영국의 주요 도시 (런던 포함)</li><li>숙박: 학교 숙박시설, 호텔, 에어비엔비, 홈스테이</li><li>실습 외 문화행사: 지역 관광명소를 방문하는 day trip, 도시의 밤을 즐길 수 있는 night out 프로그램이 준비되어 있습니다!</li>");
  }
  else if(optionArr[0]=="1" && optionArr[1]=="1" && optionArr[2]=="2" && optionArr[4]=="1"){
    index = 7;
    $(".result_country_img").attr("src", "static/public/img/country/호주1.png");
    // $("#result_country").text("호주 (Australia, NAPSA)");
    $("#result_country1").html("호주");
    $("#result_country2").html("(Australia, NAPSA)");
    ...
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>도시: 호주 전역</li><li>파견 기간: 2주 ~ 4주 (Summer / Winter)</li><li>언어: 영어</li><li>실습 기관: 지역 약국 (약대 1년 이상 수료 후 지원 가능)</li><li>숙박: 현지 약대생 Homestay (96유로/주)</li><li>실습 외 문화행사: 각 주마다 Pharmacy Student Association이 있어 지역마다의 개성이 담긴 Local Event 준비되어있습니다!</li>");
  }
    ...
    $("#result_country1").html("네덜란드");
    $("#result_country2").html("(Netherlands, K.N.P.S.V.)");
    ...
    // $("#result_text02").html(setText02);
    $("#ul_id").append("<li>실습 기관: 지역 약국, 병원약국</li><li>기간: 2주~2달(병원: 최소 3달), 5월~8월</li><li>언어: 영어</li><li>파견 도시: 네덜란드 전역</li><li>숙박: 약사 또는 네덜란드 약대생 호스트의 홈스테이 제공 가능 (무료)</li><li>실습 외 문화 행사: SEP day, SEP weekend 등을 통해 함께 여행을 떠나기도 하고, 네덜란드 현지 약학 전공자들과의 만남이 준비되어있습니다</li><br>*졸업한 학생 파견 불가, 교육 과정의 절반 이상을 수료한 학생 선호");
